...
\section{\LARGE 数据结构}
    ...
    \input{code/data_structure/link_cut_tree}
...
\section{\LARGE 计算几何}
    ...
    \input{code/geometry/point}
    \input{code/geometry/line}
...
\section{\LARGE 理论}
	...
	%\input{code/theory/prime_filter}
...
\section{\LARGE 其他}
    \input{code/other/template}
	\input{code/other/roman}
    \input{code/other/sgu261}
